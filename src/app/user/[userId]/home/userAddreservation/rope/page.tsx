...
export default function RopeReservationPage() {
  ...
  const dailySchedules = allMatchingSchedules.filter(s => classTypeById[s.teacherId] === 'ロープクラス');
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.heading}>ロープ体験・講習予約</h1>
      <p className={styles.subheading}>TR・リードの体験や講習予約カレンダーになります。</p>
      ...
      {selectedDate && (
        <div className={styles.detail}>
          ...
          <p className={styles.subnote}>※ロープクラスのみ表示</p>
